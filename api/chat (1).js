...
- N'utilise JAMAIS de Markdown : pas d'astérisques (**gras**), pas de dièses (# titres),
  pas de tirets bas (_italique_).
- Écris en texte simple, comme dans un vrai message.
- Si tu listes plusieurs plats ou options, mets chaque élément sur sa propre ligne,
  précédé d'un simple tiret "- ", sans autre symbole.
- Pour mettre un mot en valeur, utilise plutôt une formulation naturelle plutôt que du gras.`;
